...
RUN     DEBIAN_FRONTEND=noninteractive  apt-get install -y build-essential python python-virtualenv python-pip libevent-2.0-5 libevent-dev fontforge python-fontforge fonttools redis-server curl git mercurial nodejs libxslt1-dev libxml2-dev automake autoconf libtool libharfbuzz-dev libharfbuzz-dev qt5-default libffi-dev supervisor openssh-server unzip npm python-dev libsqlite-dev
...
RUN     echo "SECRET_KEY = '\x18K/\x0be\x8b9\xac\xf9\xac\x11\x88\x858\xa4~8\x03\x05\xdf\x03Y\r|'" >> /var/www/fontbakery/local.cfg
RUN     echo "GITHUB_CONSUMER_KEY = '4a1a8295dacab483f1b5'" >> /var/www/fontbakery/local.cfg
RUN     echo "GITHUB_CONSUMER_SECRET = 'ec494ff274b5a5c7b0cb7563870e4a32874d93a6'" >> /var/www/fontbakery/local.cfg
